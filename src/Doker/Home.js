      ...
      <div className="App flex justify-items-center items-center flex-col w-full   " >
        ...
        {activePopup === 'networkPopup' &&
          <div style={{ width: '300px' }} id='pop1' className="p-2 absolute  popup-main  shadow rounded overflow-y-scroll scrollbar  scrollbar-thin  scrollbar-thumb-gray-900 scrollbar-track-gray-500 ">
            ...
            <button onClick={() => { setNetworksPopup(false) }} className='bg-gray-600 hover:bg-gray-500 px-2 w-9/12 '>Remove Unused Networks</button>
                  ...
                  >
                    ...
                    <li>
                      <button
                        ...
                        className="block px-4 py-2 bg-gray-600  hover:bg-gray-500 hover:text-white w-full text-left" > Delete
                      </button>
                    </li>
                  </ul>
                </div>
        ...
        {/* Network Section Inspect/Logs */}

        {inspectPopup && selectedOption === 'Inspect' && activePopup === 'networkPopup' && (
            ...
            {popupCard ?
              ...
              <div id='pop1' className="p-2 popup-main  shadow rounded overflow-y-scroll scrollbar  scrollbar-thin  scrollbar-thumb-gray-900 scrollbar-track-gray-500 ">
                ...
                <div className='flex justify-between items-center  p-2'>
                  <button onClick={() => { setPopupCard(false) }} className='bg-gray-600 hover:bg-gray-500 px-2 w-16 '>All</button>
                  <button onClick={() => { setPopupCard(false) }} className='bg-gray-600 hover:bg-gray-500 px-2 w-16'>Used</button>
                  <button onClick={() => { setPopupCard(false) }} className='bg-gray-600 hover:bg-gray-500 px-2 w-16'>Unused</button>
                </div>

                <div className="drag-card flex bg-gray-700 p-4 items-center" id='0'
                  draggable="true"
                  onDragStart={(e) => handleDragStart(e, '0')}
                >
                  <svg className='ml-3' width="41" height="34" viewBox="0 0 41 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {activePopup === 'containers' && selectedOption !== 'Inspectc' &&
        ...
        {inspectPopup && activePopup === 'containers' || selectedOption === 'logs' || selectedOption === 'Inspectc' && (
          <div className='w-10/12 mt-5'>
            <div className='flex justify-center py-2 w-full justify-between'>
              <div className='flex items-center'>
